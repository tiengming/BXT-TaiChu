export default {
  async fetch(request, env, ctx) {
    const PENTAD_MAP = {
      ...
      "麋角解": { name: "麋角解", color: "#898989", phrase: "冬至二候，鹿角脱落" },
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-text {
            ...
            margin-bottom: 32px;
            letter-spacing: 6px;
            text-shadow: 2px 4px var(--shadow-intensity) rgba(0,0,0,0.05);
            transition: text-shadow 1s cubic-bezier(0.22, 1, 0.36, 1), color 0.5s;
        }
